...
echo -e "This script will repo-remove the git repository <repo_dirname>.git from the running git-server-hooks volume and try to create it again with repo-add. \n";

[ $# -eq 0 ] && { echo -e "Usage: $0 -d <repo-dirname> -n <hook-namespace> \nExample:\n$0 -d my-node-app"; exit 1; }
