...
# Docker wordpress
alias create-wordpress-app="bash $HOME/dotfiles/scripts/create-wordpress-app/create-wordpress-app.bash"
...
alias alias-script="/bin/sh /home/ubuntu/dotfiles/scripts/alias-script.sh"
alias docker-build-push="/bin/sh /home/ubuntu/dotfiles/scripts/docker-build-push.sh"
